  ...
  return (
    <>
      <div className="space-y-4">
        <div className="bg-green-300 relative border-4 border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] rounded-none p-4 tranform hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all duration-200">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <p className="text-xl font-bold line-through text-gray-700">
        ...
        <div className="bg-orange-300 relative border-4 border-black shadow-[6px_6px_0px_rgba(0,0,0,1)] rounded-none p-4 tranform hover:translate-x-1 hover:translate-y-1 hover:shadow-[4px_4px_0px_rgba(0,0,0,1)] transition-all duration-200">
          <div className="flex items-center gap-4">
            <div className="text-3xl cursor-pointer">
              <svg
                width="30"
